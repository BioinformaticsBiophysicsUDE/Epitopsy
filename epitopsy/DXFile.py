...
class DXBox(object):
    ...
    def __init__(self, box = None, meshsize = None, offset = None):
        ...
        self.file_path = None
        self.comment_header = "DX generated by Epitopsy"
    ...
    def setCommentHeader(self, comment):
        ...
        if isinstance(comment, basestring):
            ...
            lines = comment
        if max(len(x) for x in lines) > 79:
            warnings.warn("OpenDX comment lines shouldn't be more than 79 characters long")
